...
hardware = {
  ...
  environment.systemPackages = with pkgs; [
    ...
    tree
    htop
    zlib cmake xdotool imagemagick
...
nixpkgs.overlays = [(self: super: {
    octoprint = super.octoprint.override {
      packageOverrides = pyself: pysuper: {
        camerasettings = pyself.buildPythonPackage rec { #FIXME needs v3l-tools and updated paths
         ...
         bgcode = pyself.buildPythonPackage rec { #FIXME needs zlib and cmake and updated paths
          pname = "BGCode";
          version = "0.2.0";
          src = self.fetchFromGitHub {
            owner = "jneilliii";
...
#TODO update
        ...
        prusaslicerthumbnails = pyself.buildPythonPackage rec { #FIXME needs xdotool imagemagick and  updated paths
