    ...
    home-manager = {
        users.charles = {
            ...
            programs = {
                ...
                gpg = {
                    enable = true;
                    publicKeys = [  # https://discourse.nixos.org/t/gpg-smartcard-for-ssh/33689
                        { source = ../secrets/KK-0x05F6EFFABE002CB2-2024-01-26.asc; trust = "ultimate"; }
                        { source = ../secrets/KO-0xFE39AAD9091A1CD7-2024-01-26.asc; trust = "ultimate"; }
                    ];
                    scdaemonSettings = {
                        disable-ccid = true;
                        pcsc-shared = true;
